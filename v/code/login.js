...
////
//
//Represents our custom login provider. In addition to userame and password, 
//we require te database to use for authorization. The defaul is mutall_user
export class outlook extends provider {
    username;
    password;
    dbname;
    //
    constructor(username, password, dbname = 'mutall_users') {
        super(username, password);
        this.username = username;
        this.password = password;
        this.dbname = dbname;
    ...
    async authenticate_user() {
        ...
        //answer 
        const ans = await server.exec("database", [this.dbname], "authenticate", [this.username, this.password]);
        //
    ...
    async register_user() {
        ...
        const ans = await server.exec("database", [this.dbname], "register", [this.username, this.password]);
        //
